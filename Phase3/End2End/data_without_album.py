...
baseT = T.Compose([
        T.RandomRotation((0,15), expand=False),
        T.CenterCrop((320,320)),
        T.Resize((gendsize,gendsize)),
        T.RandomHorizontalFlip(0.5),
        T.ToTensor(),
        T.Normalize(mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)),
    ])

maskT = T.Compose(copy.deepcopy(baseT.transforms))
maskT.transforms[2].size = (masksize, masksize)
gendT = T.Compose(copy.deepcopy(baseT.transforms))
ageT  = T.Compose(copy.deepcopy(baseT.transforms))
