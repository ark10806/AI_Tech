...
class SpinalResNet(nn.Module):
    ...
    def __init__(self, block, duplicates, num_classes=10, first_HL=256, add_depth=False):
        ...
        self.conv5_x = self._make_block(block, duplicates[3], out_channels=512, stride=2)
...
def SpinalResNet34(device, num_classes, HL=512):
    return SpinalResNet(BasicBlock, [3,4,6,3], num_classes=num_classes, first_HL=HL).to(device)



class SpinalResNet_deep(nn.Module):
    """Residual Neural Network."""
